<template>
  <div class="home-container"
    ><div data-role="Header" class="home-navbar-container"
      ><div class="home-navbar"
        ...
        ><div class="home-links-container"
          ...
          ><span class="Navbar-Link">Contact</span></div
      ...
      ><div class="home-hero"
        ><div class="home-hero-text-container"
          ><h1 class="home-heading2 Section-Heading"
            >I help startups deliver the right message to their customers</h1
          ><span class="home-text Section-Text"
            ><span
              >c. Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue
          ...
          ><div class="home-cta-btn-container"
            ><button class="home-cta-btn Anchor button"
              ><span class="home-text02">MY WORK</span></button
            ><button class="home-cta-btn1 button Anchor">ABOUT ME</button></div
          ></div
        ><img
          alt="image"
          src="https://play.teleporthq.io/static/svg/default-img.svg"
          class="home-image" /></div></div
        ...
        ><div class="home-card"
          ...
          ><div class="home-content-container"
            ...
            ><span class="home-text05 Card-Text"
              ...
              nec odio. Praesent libero. Sed cursus ante dapibus diam.c Sed nisi.
              Nulla quis sem at nibh elementum imperdiet.</span
            ></div
          ></div
      ...
      ><div class="home-max-content-width-container"
        ...
        ><div class="home-content-container3"
          ...
          ><div class="home-about-11"
            ><div class="home-container06"
              ...
              ><span class="home-text12 Card-Text"
                ><span
                  ...
                  elementum</span
                ><br /><span> <span v-html="rawnxqw"></span></span></span></div
            ...
            ></div
          ></div
        ><button class="home-button Anchor button">CHECK MY WORK</button></div
      ></div
    ...
    ><div class="home-clients"
      ><div class="home-heading-container2"
        ...
        ><span class="home-text19 Section-Text"
          >Here we will put your clients&apos; or partners&apos; logos</span
        ></div
      ><div class="home-logo-container"
        ><img alt="image" src="/default-img.svg" class="home-logo" /><img
          alt="image"
          src="/default-img.svg"
          class="home-logo1" /><img
          alt="image"
          src="/default-img.svg"
          class="home-logo2" /><img
          alt="image"
          src="/default-img.svg"
          class="home-logo3" /><img
          alt="image"
          src="/default-img.svg"
          class="home-logo4" /></div></div
      ...
      ><div class="home-pricing-card-container"
        ><div class="home-card3"
          ><div class="home-card-heading"
            ...
            ><span class="Section-Heading">Basic</span></div
          ><div class="home-card-content"
            ><div class="home-feature"
              ><span class="Card-Text">Feature one</span
              ><span class="home-limit Card-Text">TBD</span></div
            ><div class="home-feature1"
              ><span class="Card-Text">Feature two</span
              ><span class="home-limit1 Card-Text">TBD</span></div
            ><div class="home-feature2"
              ><span class="Card-Text">Feature three</span
              ><span class="home-limit2 Card-Text">UNLIMITED</span></div
            ><div class="home-feature3"
              ><span class="Card-Text">Feature four</span
              ><span class="home-limit3 Card-Text">UNLIMITED</span></div
            ><button class="home-choose button Anchor">CHOOSE</button></div
          ></div
        ><div class="home-card4"
          ><div class="home-card-heading1"
            ><span class="home-type1 Anchor">medium</span
            ><span class="Section-Heading">Complex</span></div
          ><div class="home-card-content1"
            ><div class="home-container09"
              ><span class="Card-Text">Feature one</span
              ><span class="home-text23 Card-Text">TBD</span></div
            ><div class="home-container10"
              ><span class="Card-Text">Feature two</span
              ><span class="home-text25 Card-Text">TBD</span></div
            ><div class="home-container11"
              ><span class="Card-Text">Feature three</span
              ><span class="home-text27 Card-Text">UNLIMITED</span></div
            ><div class="home-container12"
              ><span class="Card-Text">Feature four</span
              ><span class="home-text29 Card-Text">UNLIMITED</span></div
            ><button class="home-button1 Anchor button">CHOOSE</button></div
          ></div
        ><div class="home-card5"
          ><div class="home-card-heading2"
            ><span class="home-type2 Anchor">Premium</span
            ><span class="Section-Heading">Professional</span></div
          ><div class="home-card-content2"
            ><div class="home-container13"
              ><span class="Card-Text">Feature one</span
              ><span class="home-text31 Card-Text">TBD</span></div
            ><div class="home-container14"
              ><span class="Card-Text">Feature two</span
              ><span class="home-text33 Card-Text">TBD</span></div
            ><div class="home-container15"
              ><span class="Card-Text">Feature three</span
              ><span class="home-text35 Card-Text">UNLIMITED</span></div
            ><div class="home-container16"
              ><span class="Card-Text">Feature four</span
              ><span class="home-text37 Card-Text">UNLIMITED</span></div
            ><button class="home-button2 Anchor button">CHOOSE</button></div
          ></div
        ></div
      ></div
    ...
    ><div class="home-faqs"
      ><h2 class="home-text38 Section-Heading">Check the most common questions</h2
      ><div class="home-content-container4"
        ><div class="home-faq"
          ><div class="home-question-container"
            ><span class="home-question"
              >Here you would write a frequently asked question?</span
            ></div
          ><div class="home-answer-container"
            ><span class="home-answer Card-Text"
              ...
              cursus ante dapibus diam.c Sed nisi. Nulla quis sem at nibh
              ...
              Praesent libero. Sed cursus ante dapibus diam.c Sed nisi. Nulla quis
              sem at nibh elementum imperdiet.</span
            ><span class="Card-Text"
              >Here you would give the answer. Lorem ipsum dolor sit amet,
              consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed
              cursus ante dapibus diam.c Sed nisi. Nulla quis sem at nibh
              elementum imperdiet.</span
            ></div
          ></div
        ><div class="home-faq1"
    ...
    ><div class="home-subscribe"
      ><img alt="image" src="/default-img.svg" class="home-image1" /><div
        class="home-container17"
        ><div class="home-heading-container4"
          ><h1 class="home-text39 Section-Heading"
            >Get our guide to crafting digital products</h1
          ><span class="Section-Text home-text40"
            >We will send you our monthly freebies on your email. We will not
            share your email address or use it for promotional goals.</span
          ></div
        ><input
          type="text"
          required="true"
        ...
        /><button class="home-button3 Anchor button">SEND</button></div
      ></div
      ...
      ><div class="home-footer"
        ...
        ><div class="home-copyright-container"
          ><svg viewBox="0 0 1024 1024" class="home-icon28">
            ...
            ></path></svg
          ><span class="Anchor">Copyright, 2021</span></div
        ></div
      ></div
    ></div
  >
...
export default {
  ...
  head: {
    title: 'teleport-hq-first',
    meta: [
      {
        property: 'og:title',
        content: 'teleport-hq-first',
      },
    ],
  },
}
